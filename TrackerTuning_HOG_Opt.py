...
def ObjectTracker(queue):
    ...
    while True:
        ...
        #scale = 1.03 worked OK, 1.08 not so much, Stride = 10 super slow, 5 wont even start, 7 wont start
        boxes, weights = hog.detectMultiScale(gray_frame, winStride=(16, 16), padding=(16, 16), scale=1.02)
